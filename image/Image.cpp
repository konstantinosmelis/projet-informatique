    ...
    if (inputImage.channels() == 1) {
        ...
        for (int i = 0; i < inputImage.rows; ++i) {
            for (int j = 0; j < inputImage.cols; ++j) {
                // Remplir le vecteur des valeurs de la fenêtre du noyau
                int index = 0;
                ...
                // Trouver la médiane sans tri en utilisant nth_element
        ...
        for (int iter = 0; iter < iterations; ++iter) {
            ...
            for (int i = 0; i < inputImage.rows; ++i) {
                for (int j = 0; j < inputImage.cols; ++j) {
                    ...
                    // Appliquer l'érosion en prenant le min du noyau
